...
const TOUR_STEPS = [
  {
    target: null,
    title: "أهلًا بك 👋",
    body: "هذه جولة تعريفية سريعة تشرح كل جزء في لوحة التحكم للتحكم في الموقع بسهولة تامة. يمكن تخطي الجولة في أي وقت.",
  },
  {
    target: '[data-section="contact"]',
    title: "بيانات التواصل",
    body: "من هذا القسم يتم تعديل رقم الهاتف، واتساب، البريد الإلكتروني، العنوان، وساعات العمل — وتظهر تلقائيًا في كل صفحات الموقع.",
  },
  {
    target: '[data-section="texts"]',
    title: "النصوص التعريفية",
    body: 'من هذا القسم يتم تعديل نصوص الصفحة الرئيسية، وصفحة "من نحن"، وبيانات قيادة المكتب.',
  },
  {
    target: '[data-section="practices"]',
    title: "الخدمات / مجالات الاختصاص",
    body: "من هذا القسم يتم إضافة أو تعديل أو حذف خدمات المكتب التي تظهر في صفحة الخدمات.",
  },
  {
    target: '[data-section="cases"]',
    title: "القضايا",
    body: "من هذا القسم يتم إضافة أو تعديل القضايا، مع إمكانية رفع صورة لكل قضية.",
  },
  {
    target: '[data-section="blog"]',
    title: "مقالات المدونة",
    body: "من هذا القسم يتم إضافة مقالات قصيرة تظهر في صفحة المدونة.",
  },
  {
    target: "#refreshBtn",
    title: "زر التحديث",
    body: "عند إجراء أي تعديل من جهة أخرى، يُستخدم هذا الزر لتحديث كل البيانات فورًا دون الحاجة لتسجيل الخروج والدخول مرة أخرى.",
  },
  {
    target: "#reportIssueBtn",
    title: "الإبلاغ عن عطل",
    body: "في حال حدوث أي مشكلة أو خلل، يُستخدم هذا الزر للتواصل المباشر عبر واتساب.",
  },
  {
    target: '[data-section="account"]',
    title: "إعدادات الحساب",
    body: "من هذا القسم يمكن تغيير كلمة المرور في أي وقت.",
  },
  {
    target: '[data-section="publish"]',
    title: "⚠️ الخطوة الأهم: حفظ ونشر التعديلات",
    body: 'أي تعديل يتم إجراؤه في أي قسم (تواصل، نصوص، خدمة، قضية، مقالة) يُحفظ محليًا فقط، ولا يظهر على الموقع الفعلي إلا بعد الضغط على زر "حفظ ونشر التعديلات" في هذا القسم. دون هذه الخطوة، لن تظهر التعديلات لأي زائر للموقع.',
  },
];
